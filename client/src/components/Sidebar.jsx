...
export default function Sidebar() {
  ...
  const favorites = [
    { name: 'Shared with me', icon: <Share2 size={20} />, path: '/shared' },
  ...
  return (
    <aside 
      ...
      className={`fixed lg:relative z-50 h-screen bg-[#0A0B14]/95 backdrop-blur-2xl border-r border-white/5 flex flex-col text-gray-300 font-sans transition-all duration-400 ease-in-out ${
